...
<head>
    ...
    <title>WhatsApp Chat - <?php echo e($user['name']); ?></title>
    <style>
            ...
            <div class="header">
                <div class="user-info">
                    <div>
                        ...
                        <span class="role-badge"><?php echo e($user['permissions']['role_name']); ?></span>
                        <div class="permissions">
                            <?php if($user['permissions']['can_see_all']): ?>
                                ✓ Can see all conversations
                            <?php else: ?>
                                ⚠ Limited to assigned conversations
                            <?php endif; ?>
                            <?php if($user['permissions']['can_see_phone']): ?>
            ...
            conversations = [
                {
                    id: 1,
                    name: 'Customer #1',
                    phone: '<?php echo e($user['permissions']['can_see_phone'] ? '1234567890' : '123*****890'); ?>',
                ...
                },
                {
                    id: 2,
                    name: 'Customer #2', 
                    phone: '<?php echo e($user['permissions']['can_see_phone'] ? '0987654321' : '098*****321'); ?>',
...
</html><?php /**PATH /home/u539863725/domains/al-najjarstore.com/public_html/connect/resources/views/whatsapp/dashboard.blade.php ENDPATH**/ ?>